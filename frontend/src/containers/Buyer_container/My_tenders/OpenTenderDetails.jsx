        ...
        <form onSubmit={handleSubmit}>
          <div className="tender_announcement">
            <div className="center-content">
              <p className="natinoal" style={{ fontSize: '30px' }}>لقد تم تقديم {tender.number_of_responses} عرض حتي الان</p>
            </div>
...
export default OpenedTenderDetails;
